...
private object InternalMessagingAttributes {
  ...
  // specialized well know attributes

  val BatchSingleton: Attribute[Long] = MessagingExperimentalAttributes.MessagingBatchMessageCount(1L)

  val Send: Attribute[String] = MessagingExperimentalAttributes.MessagingOperationType(
    MessagingExperimentalAttributes.MessagingOperationTypeValue.Send.value)
  val Receive: Attribute[String] = MessagingExperimentalAttributes.MessagingOperationType(
    MessagingExperimentalAttributes.MessagingOperationTypeValue.Receive.value)
  val Settle: Attribute[String] = MessagingExperimentalAttributes.MessagingOperationType(
    MessagingExperimentalAttributes.MessagingOperationTypeValue.Settle.value)
