 ...
 */
sealed abstract class MessageContext[F[_], T](implicit F: Temporal[F]) extends Message[F, T] {
...
abstract private[queue] class UnsealedMessageContext[F[_], T](implicit F: Temporal[F]) extends MessageContext[F, T]
